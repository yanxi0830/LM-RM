...
from worlds.keyboard_world import KeyboardWorldParams


class TesterKeyboardWorld:
    ...
    def get_task_params(self, task_specification):
        params = KeyboardWorldParams(self.map, self.tabular_case)
        return GameParams("keyboardworld", params)
