...
class PolicyDQN(Policy):
    def __init__(self, sess, policy_name, s1, a, s2, IS_weights, use_priority, num_features, num_actions, gamma, lr,
                 tabular_case, use_double_dqn, num_hidden_layers, num_neurons):
